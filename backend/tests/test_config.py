...
from backend.app.core.config import load_config, get_public_config, ConfigError
...
class TestConfig(unittest.TestCase):
    ...
    def test_load_config_success(self):
        cfg = load_config()
        self.assertEqual(cfg["TIINGO_API_KEY"], "tiingo-key")
        self.assertEqual(cfg["SUPABASE_URL"], "https://supabase.test")
        self.assertIn("TIINGO_BASE_URL", cfg)
    ...
    def test_get_public_config(self):
        ...
        self.assertIn("TIINGO_BASE_URL", public_cfg)
